      ...
      <el-col :span="7">
        <el-card>
          ...
          <el-row class="user-info-fullInfo">
            <div style="margin-left:10px;" >姓名：{{form.realName}}</div>
            <div style="margin-left:10px; margin-top:10px;">年级：{{levelFormatter(form.userLevel)}}</div>
            <div style="margin-left:10px; margin-top:10px;">注册时间：{{form.createTime}}</div>
          </el-row>
        </el-card>
      </el-col>
      <el-col :span="17">
