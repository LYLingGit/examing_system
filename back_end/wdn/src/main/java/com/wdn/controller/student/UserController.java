...
import com.wdn.domain.enums.UserStatusEnum;
import com.wdn.event.UserEvent;
import com.wdn.service.AuthenticationService;
...
import com.wdn.viewmodel.student.user.*;
...
public class UserController extends BaseApiController {
    ...
    public RestResponse register(@RequestBody @Valid UserRegisterVM model) {
        ...
        userEventLog.setContent("欢迎 " + user.getUserName() + " 注册来到王东南互联网考试系统");
